...
export async function generateMetadata(
  ...
  const product = await fetch(`https://genshin-db-api.vercel.app/api/v5/weapons?query=${id.replace(/-/g, '')}&resultLanguage=portuguese`, { cache: 'force-cache' }).then((res) => res.json())
...
const validIds = await fetch('https://genshin-db-api.vercel.app/api/v5/weapons?query=names&matchCategories=true', { cache: 'force-cache' })
  .then(res => res.json());
