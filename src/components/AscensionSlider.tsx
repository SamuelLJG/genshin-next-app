...
export default function AscensionSlider({currentCosts}:any) {
  ...
  return (
    <>
      ...
      <div className="ascension-costs-flex">
        <label htmlFor="ascension-costs-slider">Custo {level-1}→{level}&nbsp;<Image width={50} height={50} src={`https://gi.yatta.moe/assets/UI/UI_ItemIcon_${currentCosts2[0].id}.png`} alt={currentCosts2[0].name}/>{currentCosts2[0].count/1000}K</label>
