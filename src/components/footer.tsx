    ...
    return (
        ...
        <footer>
            ...
            <Link href="https://mail.google.com/mail/?view=cm&to=genshinbuildsite@gmail.com" target="_blank" className="discord">
                <div>
                <Image width={22} height={22} loading="eager" src="/images/email-1572-svgrepo-com.svg" alt="Contact"/>
                </div>    
                <span>Contact</span>
            ...
            <Link href="/en/privacy-policy" className="discord">
                            <div>
                            <Image width={22} height={22} loading="eager" src="/images/policy-round-svgrepo-com.svg" alt="Privacy Policy"/>
                            </div>    
